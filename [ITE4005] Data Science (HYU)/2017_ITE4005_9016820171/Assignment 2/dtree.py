...
def get_classification(record, tree):
    ...
    # If the current node is a string, then return it
...
def create_decision_tree(data, attributes, target_attr, fitness_func):
    ...
    # return that classification.
        ...
        # Choose the next best attribute to best classify the data
        ...
        for val in get_values(data, best):
            ...
            # Add the new subtree to the empty dictionary object in the tree
