package com.cs442.mvarhola.l12workshop;
...
public class CameraDemoActivity extends AppCompatActivity implements
    ...
    public static final CameraPosition CHICAGO =
            new CameraPosition.Builder().target(new LatLng(41.8781, -87.6298))
                    .zoom(15.5f)
                    .bearing(0)
                    .tilt(0)
                    .build();
     ...
     */
    public void onGoToChicago(View view) {
        if (!checkReady()) {
            return;
        }

        changeCamera(CameraUpdateFactory.newCameraPosition(CHICAGO));
    }
