...
public class VarholaM_lab11_GenericList<T> {
	...
	public VarholaM_lab11_GenericList(){
	...
	@SuppressWarnings("unchecked")
	public VarholaM_lab11_GenericList(int size){
	...
	public boolean equals(VarholaM_lab11_GenericList<T> anArray){
