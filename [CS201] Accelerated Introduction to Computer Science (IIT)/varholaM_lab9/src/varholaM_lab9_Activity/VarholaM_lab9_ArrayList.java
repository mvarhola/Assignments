...
public class VarholaM_lab9_ArrayList {
	...
	//default constructor
	public VarholaM_lab9_ArrayList(){
		objArray = new Object[MAX_SIZE];
		iterator=0;
	}
	
	//nondefault constructor
	public VarholaM_lab9_ArrayList(int size){
	...
	public boolean equals(VarholaM_lab9_ArrayList anArray){
	...
	public boolean hasNext(){
		return (iterator<index && objArray[iterator+1]!=null);
	}
